      ...
      >
        {teamMembers.map((person, i) => (
          <div
            ...
            "
          >
            <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full overflow-hidden bg-gray-100 flex-shrink-0 mb-4 sm:mb-0">
              {person.image ? (
                <img
                  src={person.image}
                  alt={person.name}
            ...
            <div className="sm:ml-6">
              ...
              <p className="text-[#0e1a67] font-semibold mb-3">{person.role}</p>
              <p className="text-gray-700 whitespace-pre-line text-sm leading-relaxed max-w-xl">
                {person.desc}
              </p>
            </div>
          </div>
